...
const nav:[string,string][]=[['My work','/work'],['Overview','/overview'],['Parties','/parties'],['Evidence','/evidence'],['Obligations','/obligations'],['Journals','/ledger/journals'],['Chart of accounts','/ledger/accounts'],['Periods and close','/ledger/periods'],['Imports','/ledger/imports'],['Reports','/reports'],['Money in','/sales/invoices'],['Money out','/purchases/bills'],['Compliance','/compliance']];
const roadmap:Record<string,string>={'/sales/invoices':'Sales invoicing arrives with the sales module (P04).','/purchases/bills':'Purchasing and payables arrive with P05.','/compliance':'Compliance and e-invoicing arrive with P07.','/payments':'Payments arrive with treasury (P06).','/bank/reconcile':'Bank reconciliation arrives with treasury (P06).'};
