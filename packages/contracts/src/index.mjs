...
export const accountingCaseDefinitions=Object.freeze(new Map(JSON.parse(readFileSync(new URL('../../../docs/development/contracts/accounting-cases.json',import.meta.url),'utf8')).cases.map(c=>[c.id,c])));
