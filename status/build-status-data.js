window.LARA_BUILD_STATUS = {
  "version": 1,
  "updated_at": "2026-09-20T19:01:16+00:00",
  "releases": [
    {
      "id": "P00",
  ...
  "tickets": [
    ...
    },
    {
      ...
      "evidence": "Local: scripts/test-p12-schema.mjs passes (4 groups); migration applied on the dev database; validate_specifications PASS. CI run pending.",
      "updated_at": "2026-09-20T17:32:29+00:00"
    },
    {
      "id": "P12-02",
      "phase": "P12",
      ...
      "evidence": "Local: scripts/test-p12-domain.mjs passes (6 groups: P12-T01..T05). CI run pending.",
      "updated_at": "2026-09-20T17:32:29+00:00"
    },
    {
      "id": "P12-03",
      ...
      "evidence": "Local: scripts/test-p12-api.mjs passes (4 groups, API and worker as processes). CI run pending.",
      "updated_at": "2026-09-20T17:32:29+00:00"
    },
    {
      "id": "P12-04",
      ...
      "evidence": "Local: tsc --noEmit and pnpm build pass; the assistant journey passed in the full browser run of 2026-09-21 (13 passed, one unrelated timing flake in the institution journey on the shared dev database in later runs). CI run pending.",
      "updated_at": "2026-09-20T19:01:16+00:00"
    },
    {
      "id": "P12-05",
      ...
      "evidence": "Local: p12 schema/domain/api suites pass; CI run pending.",
      "updated_at": "2026-09-20T17:32:29+00:00"
    },
    {
      "id": "P12-06",
