...
try{
 ...
 for(const [name,upgrade] of [['lara_ci_clean',false],['lara_ci_upgrade',true]]){
  ...
  for(const script of ['scripts/test-foundation-db.mjs','scripts/test-subject-isolation.mjs','scripts/test-restore.mjs','scripts/test-api-readiness.mjs','scripts/test-readiness-recovery.mjs','scripts/test-worker.mjs','scripts/test-demo-workflows.mjs','scripts/test-p02-schema.mjs','scripts/test-p02-domain.mjs']){
