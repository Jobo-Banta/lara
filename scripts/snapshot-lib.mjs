...
export const tables=['public.schema_migrations','lara.demo_seed_runs','lara_demo.runs','lara_demo.tasks','lara_demo.invoices','lara_demo.bills','lara_demo.reconciliation_lines','lara_demo.close_tasks','lara_demo.compliance_items','lara_demo.evidence','lara_demo.feedback'];
