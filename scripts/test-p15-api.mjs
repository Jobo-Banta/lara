...
try{
 ...
 r=await call(ACC,'POST','/packs/install',{body:{packId:'retail-ph',version:'1.0.0',manifestHash:'0'.repeat(64),evidenceIds:['00000000-0000-4000-8000-000000000001']},headers:{...key(),...ph}});assert.ok([403,404,409].includes(r.status),'later-phase operations stay gated or refused for the caller');
