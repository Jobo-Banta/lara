...
- Share grants over non-enumerable tokens (tenant-prefixed) expose kind, number, date, gross, currency, state and a masked party display for posted documents until expiry — no TIN, address, full document or acceptance assertion.
